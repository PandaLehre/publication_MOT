...
This was done to ensure that the network was trained on tracks with a sufficient number of time stamps. In software development of tracking systems, it is common to use a threshold value to filter tracks that are too short to allow a meaningful prediction. %[MD: Citation?]
...
% 	\ch{Currenlty no other work was found. If we find one, we will include it.}
% \end{itemize}}
...
\md{Most important results, critical analysis (optional), future work: attention vs LSTMs?, größere Datensätz, association probabilities?}
