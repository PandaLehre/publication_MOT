...
Furthermore, the math and the theory itself is clean and comprehensible. \menz{I'd remove the previous sentence. This should be true for all approaches, I guess.}
...
%ME: That's a long sentence ... I've split it up. 
...
However, development for automated driving is highly complex~{\cite{AD_Overview.2017}} . In the automotive industry, 
tracking systems are not developed for a single model; instead, they are usually created as platform software. 
This software is deployed across a variety of different vehicle models, each with distinct sensor sets and 
installation heights. Additionally, these systems must operate in various countries and consistently perform 
