...
To enable our models to incorporate temporal information, we use \ac{LSTM} {\cite{DL_LSTM.1997}} and \ac{BiLSTM} network layers {\cite{DL_BILSTM.1997}}, both for the prediction and the association of the sensor objects to the existing tracks.
