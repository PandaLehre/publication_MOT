...
%MD: Der erste Absatz hier sollte in related work.
...
%MD: NOrmalization layer umbennen in Batch-Normalization Layer
\begin{figure}[htbp]
...
where $A_i$ the combined length of all tracks and $N$ is the number of states.
...
%MD: =========== Bis hierhin habe ich gelesen ====================
