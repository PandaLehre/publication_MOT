...
The values obtained in this way were assigned as shown in Fig. \ref{pic::MantaData} as measurements in pseudo-random order per time step assigned to an $F * T_{max}$ matrix. %MD: Die fig 5 zeigt aber gar kein assignment.
...
(here, $F = 2 * m$, with $m=5$ being the number of state values in this investigation).
