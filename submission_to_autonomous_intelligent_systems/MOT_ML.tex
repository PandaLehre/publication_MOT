...
\paragraph*{Availability of data and materials} All used datasets are publicly available, see {\cite{Geiger2012CVPR}} for details. Model parameters are available upon request. Since they were developed within Daimler Truck AG internal research, no direct download is provided.
\paragraph*{Competing interests} None.
\paragraph*{Acknowledgments and funding}
...
\paragraph*{Autors' contribution} Conceptualization (CH, CB, ME, MD), Investigation (CH, CB),  Software (CH, CB), Visualization (CH), Data curation (CH, CB), Original draft preparation (CH, MD), Reviewing (CH, CB, ME, MD), Editing (CH, CB, ME, MD)
